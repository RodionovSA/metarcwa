...
# _REAL_TO_COMPLEX / to_complex / to_real live in metarcwa._dtypes (shared by
# both `model` and `solver`, see that module's docstring); re-exported here
# for existing importers of metarcwa.model.utils.
